...
<?php
echo form_open('supplier/post');
?>
<table class="table table-bordered">
    <tr><td width="130">Nama Customer</td>
        <td><div class="col-sm-4""><input type="text" name="nama" class="form-control" placeholder="Nama Supplier"></div>
       </td></tr>
    ...
    <tr><td colspan="2"><button type="submit" class="btn btn-primary btn-sm" name="submit">Simpan</button>
        <?php echo anchor('suppplier','Kembali',array('class'=>'btn btn-primary btn-sm'))?>
        </td></tr>
</table>
</form>